...
export default function Home() {
  return (
    <>
      ...
      {/* Hero Section — Animated Gradient Orbs on All Viewports */}
      <section className="relative min-h-[85vh] sm:min-h-[90vh] bg-foreground text-white overflow-hidden flex items-center">
          ...
          <div className="max-w-2xl text-center sm:text-left mx-auto sm:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8">
              ...
              <Link
                ...
                className="bg-white/10 backdrop-blur-sm border border-white/30 text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl text-base font-semibold hover:bg-white/25 transition-colors inline-flex items-center justify-center gap-2 min-h-[48px]"
              >
                Size My System
              </Link>
            </div>
        ...
        <div className="hidden lg:block absolute right-12 xl:right-16 top-1/2 -translate-y-1/2 space-y-4 z-10">
          <div className="bg-white/[0.08] backdrop-blur-xl rounded-2xl p-5 shadow-2xl border border-white/[0.12]">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl font-extrabold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">$3,000+</div>
                <div className="text-xs text-white/60">Average Savings vs Pro Install</div>
              </div>
            </div>
          </div>
          <div className="bg-white/[0.08] backdrop-blur-xl rounded-2xl p-4 shadow-2xl border border-white/[0.12]">
            ...
            <div className="text-xs font-bold text-white">4.8/5 · 2,300+ reviews</div>
          </div>
        </div>
