...
function ToastItem({ toast, onRemove }: { toast: Toast; onRemove: (id: string) => void }) {
  ...
  return (
    <div
      className={`pointer-events-auto flex items-center gap-3 px-5 py-3.5 rounded-xl shadow-2xl text-white text-sm font-medium ${bgColor} transition-all duration-300 ${
